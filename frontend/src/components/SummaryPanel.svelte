    ...
    <div class="grid grid-cols-1 md:grid-cols-3" style="gap: 2rem;">
      <div style="display: flex; flex-direction: column; gap: 0.75rem;">
        ...
        <div class="text-4xl font-light text-[#2c3e50]">
          {summary.averages.temperature.toFixed(1)}<span class="text-lg text-[#219ebc]">°C</span>
        </div>
      </div>
      ...
      <div style="display: flex; flex-direction: column; gap: 0.75rem;">
        ...
        <div class="text-4xl font-light text-[#2c3e50]">
          {summary.averages.humidity.toFixed(0)}<span class="text-lg text-[#219ebc]">%</span>
        </div>
      </div>
      ...
      <div style="display: flex; flex-direction: column; gap: 0.75rem;">
        ...
        <div class="text-4xl font-light text-[#2c3e50]">
          {summary.averages.wind_speed.toFixed(1)}<span class="text-lg text-[#219ebc]">km/h</span>
        </div>
      </div>
    </div>
  </div>
